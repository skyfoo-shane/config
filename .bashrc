...
export HISTCONTROL=erasedups	# Remove dupes from history
export HISTSIZE=10000000	# Make the history ridiculously large
shopt -s histappend		# On shell exit append history rather than overriding
